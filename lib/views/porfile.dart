  ...
  Widget buildName() => Center(
    ...
    child: Card(
      ...
      child: SizedBox(
        ...
        child: Column(
          children: const  [
            Text('\n User Data', style: TextStyle(fontWeight: FontWeight.bold, fontSize:24)),
            Text('\n Name:  Daniel', style: TextStyle( color: Colors.blueGrey,fontSize:20)),
            Text('\n Last Name : Monsalve Jaraba', style: TextStyle(color:Colors.blueGrey, fontSize:20)),
            Text('\n e-Mail : daniel@gmail.com', style: TextStyle(color:Colors.blueGrey, fontSize:20)),
            Padding(
              padding: EdgeInsets.all(14.0),
              child: Text('\n Telephone : 3114587899', style: TextStyle(color:Colors.blueGrey, fontSize:20)),
            ),
    ...
    Widget buildProfileImage(height) => CircleAvatar(
      ...
      backgroundImage: NetworkImage('https://mysuenos.com/wp-content/uploads/2019/10/joven.jpg'),
      radius: 65,
    ),
